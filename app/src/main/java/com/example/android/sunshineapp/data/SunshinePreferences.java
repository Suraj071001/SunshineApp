...
public class SunshinePreferences {
    ...
    //In order to uniquely pinpoint the location on the map when we launch the map intent, we store the latitude and longitude.
    public static final String PREF_COORD_LAT = "coord_lat";
    public static final String PREF_COORD_LONG = "coord_long";


    //Helper method to handle setting location details in Preferences (City Name, Latitude,Longitude)
